...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "TuristickaAgencija.MobileApp.Android.dll" comes first in this list. */
		"TuristickaAgencija.MobileApp.Android.dll",
		"TuristickaAgencija.Model.dll",
		"Flurl.dll",
		"Flurl.Http.dll",
		"FormsViewGroup.dll",
		...
		"TuristickaAgencija.MobileApp.dll",
