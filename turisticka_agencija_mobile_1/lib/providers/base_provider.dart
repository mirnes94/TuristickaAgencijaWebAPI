...
abstract class BaseProvider<T> with ChangeNotifier {
  ...
  BaseProvider(String endpoint) {
    ...
    _baseUrl = const String.fromEnvironment("baseUrl", defaultValue: "http://127.0.0.1:5000/");
 ...
 */
  ...
  bool isValidResponseCode(Response response) {
    if (response.statusCode == 200) {
      // Proveri da li je telo odgovora prazno
      if (response.body.isNotEmpty) {
        return true; // Vrati true samo ako telo odgovora nije prazno
      } else {
        return false; // Inače vrati false
      }
    } else {
      // Vrati true za sve druge uspešne statusne kodove
