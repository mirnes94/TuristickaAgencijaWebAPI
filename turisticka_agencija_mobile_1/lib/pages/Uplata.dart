...
import 'package:turisticka_agencija_mobile_1/utils/util.dart';
 ...
 */
  ...
  Future<void> makePayment(String iznosUplate) async {
    try {
      // Stvorite "PaymentIntent" objekat putem Stripe API-ja
      ...
      Map<String, dynamic> body = {
        'amount': calculateAmount(iznosUplate),
        'currency': 'USD',
        'payment_method_types[]': 'card',
      };

      // Ovde možete implementirati logiku za prosleđivanje korisnika na svoju serversku stranicu za plaćanje
      // gde će se komunicirati sa Stripe-ovim API-jem za procesuiranje plaćanja
      ...
      print('Greška prilikom plaćanja: $e $s');
      // Ovdje možete prikazati poruku o grešci korisniku
    }
  }
  ...
  Future<Uplate?> addUplata(int brojRezervacije, int iznosUplate) async {
    ...
    if (id != 0) {
      ...
      print('Body - addUplata' + iznosUplate.toString() + "-"+ brojRezervacije.toString() +id.toString());
